...
@Component({
  selector: 'pbsmeta.service.ts-home',
  template: `
    <div class="grid gap-x-4 grid-cols-1 lg:grid-cols-4">
      <aside class="col-span-4 lg:col-span-1">
        <div class="max-w-full lg:max-w-sm rounded overflow-hidden shadow-common p-4 relative">
          <pbs-theme-toggler positionClass="absolute top-1 right-1"></pbs-theme-toggler>
          <pbs-avatar></pbs-avatar>
          <pbs-info></pbs-info>
          <pbs-navigation></pbs-navigation>
          <pbs-socials></pbs-socials>
          <pbs-copyright></pbs-copyright>
        </div>
      </aside>
