...
export class IntersectionObserveeDirective extends Destroyable implements AfterViewInit {
  ...
  @Input('pbsIntersectionObserveeDebounce') debounce = 0;

  @Input('pbsIntersectionObserveeElse') set elseTemplate(templateRef: TemplateRef<unknown>) {
